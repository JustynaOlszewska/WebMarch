...
const showInformationVegetables = lazy(() =>
  ...
  return (
    <main className="main">
      <Suspense fallback={<Loading />}>
        <Switch>
          <Route path={PATH_ROUTER.webMarch} component={Home}></Route>
          <Route path={PATH_ROUTER.main} exact component={Home}></Route>
          <Route path={PATH_ROUTER.garden} exact component={Garden}></Route>
          <Route
            path={`${PATH_ROUTER.garden}:vegetable`}
            component={showInformationVegetables}
          ></Route>

          <Route path={PATH_ROUTER.login} component={Login}></Route>
          <Route path={PATH_ROUTER.admin} component={AdminPage}></Route>
          <Route path={PATH_ROUTER.me} component={Me}></Route>
