...
import 'react-gsap/node_modules/gsap/CSSPlugin';
...
const mainList = [{name:"Home", id:1, to:"/"},{name: "Backyard garden", id:2,to:"/garden" },{name:"For logged in users", id:3, to:"/login"},{name:"Ask me", id:4, to:"/me"}]
